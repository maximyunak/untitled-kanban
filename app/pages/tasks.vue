...
const handleCheckboxChange = async (isCompleted: string | boolean, task: ITaskWithBoardId) => {
  ...
  <div>
    ...
    <div class="mt-5">
      ...
      <div v-if="completedTasks.length > 0">
        ...
        <ClientOnly>
          <UPagination v-if="(data?.completed?.totalPages ?? 0) > 1" class="pagination flex justify-center mt-4"
                       color="neutral"
